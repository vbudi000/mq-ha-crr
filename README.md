...
4. [Demonstrate Native HA and Planned Site Failover](004-nativeHA.md)
5. [Demonstrate Unplanned Failover and Split-Brain Recovery](006-crr-unplanned.md)

Sections 1–3 cover setup and installation. Sections 4–5 are demonstration steps. If you make a mistake during setup, delete the Queue Managers and redo step 3 to recreate the Native HA CRR environment.

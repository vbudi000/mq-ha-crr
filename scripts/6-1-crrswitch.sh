...
dir=${2}
QMGR=${qmname}
mkn2y="sudo awk -i inplace '{gsub(/Enabled=No/, \"Enabled=Yes\")} 1' /var/mqm/qmgrs/${QMGR}/qm.ini"
mky2n="sudo awk -i inplace '{gsub(/Enabled=Yes/, \"Enabled=No\")} 1' /var/mqm/qmgrs/${QMGR}/qm.ini"
